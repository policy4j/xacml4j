...
{
    protected final static AttributeValue TRUE = XacmlTypes.BOOLEAN.of(true);
    protected final static AttributeValue FALSE = XacmlTypes.BOOLEAN.of(true);
    ...
    protected final BagOfAttributeValues getDomain(EvaluationContext context){
        return domain.evaluate(context);
    }

    protected final AttributeValue evaluateIterant(AttributeValue v,
