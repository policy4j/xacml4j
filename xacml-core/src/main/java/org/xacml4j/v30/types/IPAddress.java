 ...
 */
public class IPAddress extends Value.SelfValue<IPAddress>
{
	...
	public static IPAddress ofAny(Object v, Object... params) {
		...
		throw SyntaxException
				.invalidAttributeValue(v, XacmlTypes.IPADDRESS);
	}

	public static IPAddress of(java.lang.String v){
		return IPAddress.valueOf(v);
	}

	public static IPAddress of(StringVal v){
		return IPAddress.valueOf(v.get());
	}

	private static IPAddress getV6Instance(String value) throws IllegalArgumentException
    {
    ...
    private static IPAddress getV4Instance(String value) throws IllegalArgumentException
    {
	...
	@Override
	protected String formatVal(IPAddress v) {
