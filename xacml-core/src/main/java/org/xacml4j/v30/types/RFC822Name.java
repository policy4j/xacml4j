...
public final class RFC822Name extends Value.SelfValue<RFC822Name> implements Serializable
{
	...
	RFC822Name(String localPart, String domainPart) {
		super(XacmlTypes.RFC822NAME);
	...
	public static RFC822Name ofAny(Object v, Object ...params){
		...
		throw SyntaxException
				.invalidAttributeValue(v, XacmlTypes.RFC822NAME);
	}
	...
	public static RFC822Name of(String v){
		return RFC822Name.parse(v);
	}
	public static RFC822Name of(StringVal v){
		return RFC822Name.parse(v.get());
	}
	...
	public StringVal toStringVal(){
		return StringVal.of(fqName);
	}

	@Override
	public int hashCode(){
		return Objects.hash(fqName, getEvaluatesTo());
	}

	@Override
	protected String formatVal(RFC822Name v) {
		return fqName;
	}
