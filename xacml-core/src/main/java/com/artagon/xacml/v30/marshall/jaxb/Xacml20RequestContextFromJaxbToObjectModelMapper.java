...
class Xacml20RequestContextFromJaxbToObjectModelMapper
{
	private final static Logger log = LoggerFactory.getLogger(Xacml20RequestContextFromJaxbToObjectModelMapper.class);
