...
public class AnyURITest
{
	...
	{
		Value v0 = XacmlTypes.ANYURI.ofAny("http://www.test.org");
		Value v1 = XacmlTypes.ANYURI.ofAny("http://www.test.org");
		assertEquals(v0, v1);
	...
	public void testBagOf(){
		Value v0 = XacmlTypes.ANYURI.ofAny("http://www.test.org");
		Value v1 = XacmlTypes.ANYURI.ofAny("http://www.test1.org");
