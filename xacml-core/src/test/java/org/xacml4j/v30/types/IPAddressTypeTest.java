...
public class IPAddressTypeTest
{
	...
	{
		AttributeExp a0 = IPAddressExp.of("127.0.0.1");
		assertEquals("127.0.0.1", TypeToString.Types.IPADDRESS.toString(a0));
		AttributeExp a1 = IPAddressExp.of(
				IPAddress
				.builder()
				.address("127.0.0.1")
				.mask("255.255.255.0")
		...
		AttributeExp a2 = IPAddressExp.of(
				IPAddress.builder()
				.address("127.0.0.1")
				.mask("255.255.255.0")
				.portRange("1024-2048")
				.build());
		AttributeExp a3 = IPAddressExp.of("127.0.0.1/255.255.255.0:1024-2048");
	...
	{
		AttributeExp a0 = IPAddressExp.of("[2001:0db8:85a3:0000:0000:8a2e:0370:7334]");
		assertEquals("[2001:db8:85a3:0:0:8a2e:370:7334]", TypeToString.Types.IPADDRESS.toString(a0));
		AttributeExp a1 = IPAddressExp.of(IPAddress
				.builder()
