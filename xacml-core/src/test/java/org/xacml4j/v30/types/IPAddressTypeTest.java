...
public class IPAddressTypeTest
{
	...
	{
		IPAddressValue a0 = XacmlTypes.IPADDRESS.of("127.0.0.1");
		assertEquals("127.0.0.1", TypeToString.Types.IPADDRESS.toString(a0));
		IPAddressValue a1 = XacmlTypes.IPADDRESS.of(
				IPAddress
				.builder()
				.address("127.0.0.1")
				.mask("255.255.255.0")
		...
		IPAddressValue a2 = XacmlTypes.IPADDRESS.of(
				IPAddress.builder()
				.address("127.0.0.1")
				.mask("255.255.255.0")
				.portRange("1024-2048")
				.build());
		IPAddressValue a3 = XacmlTypes.IPADDRESS.of("127.0.0.1/255.255.255.0:1024-2048");
	...
	{
		IPAddressValue a0 = XacmlTypes.IPADDRESS.of("[2001:0db8:85a3:0000:0000:8a2e:0370:7334]");
		assertEquals("[2001:db8:85a3:0:0:8a2e:370:7334]", TypeToString.Types.IPADDRESS.toString(a0));
		AttributeValue a1 = XacmlTypes.IPADDRESS.of(IPAddress
				.builder()
	...
	{
		IPAddressValue v = (IPAddressValue)TypeToString.Types.IPADDRESS.fromString("127.0.0.1/127.0.0.1:80");
		assertNotNull(v);
