...
public class EUI48Test {
	...
	private static final String FIRST_GROUP_ALL_NUM_ETHERNET_ADDRESS_STRING_H = "00-23-45-67-89-ab";
	private static final String FIRST_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING = "0:23:45:67:89:ab";
	private static final String FIRST_GROUP_ONE_NUM_ETHERNET_ADDRESS_STRING_H = "0-23-45-67-89-ab";
	...
	private static final String LOWER_CASE_VALID_ETHERNET_ADDRESS_STRING = VALID_ETHERNET_ADDRESS_STRING;
	...
	private static final byte[] VALID_ETHERNET_ADDRESS_BYTE_ARRAY = {
			(byte) 0x87, (byte) 0xf5, (byte) 0x93, (byte) 0x06, (byte) 0xd3,
			(byte) 0x0c };
	private static final int[] VALID_ETHERNET_ADDRESS_INT_ARRAY = { 0x87, 0xf5,
			0x93, 0x06, 0xd3, 0x0c };

	private static final byte[] ANOTHER_VALID_ETHERNET_ADDRESS_BYTE_ARRAY = {
			(byte) 0x4c, (byte) 0xde, (byte) 0xfb, (byte) 0xba, (byte) 0x5a,
			(byte) 0x1c };
	/*
	 * private static final EthernetAddress VALID_ETHERNET_ADDRESS = new
	 * EthernetAddress(VALID_ETHERNET_ADDRESS_LONG); private static final String
	 * ANOTHER_VALID_ETHERNET_ADDRESS_STRING = "4c:de:fb:ba:5a:1c"; private
	 * static final long ANOTHER_VALID_ETHERNET_ADDRESS_LONG =
	 * 0x00004cdefbba5a1cL; private static final int[]
	 * ANOTHER_VALID_ETHERNET_ADDRESS_INT_ARRAY = { 0x4c, 0xde, 0xfb, 0xba,
	 * 0x5a, 0x1c };
	 */
	// private static final EthernetAddress ANOTHER_VALID_ETHERNET_ADDRESS = new
	// EthernetAddress(ANOTHER_VALID_ETHERNET_ADDRESS_LONG);

	// some ethernet addresses for the ordering tests
	private static final EUI48 MAC0_ETHERNET_ADDRESS = new EUI48(
			0x0000015ae2e61893L);
	private static final EUI48 MAC1_ETHERNET_ADDRESS = new EUI48(
			0x00001f0f1b0e8e6eL);
	private static final EUI48 MAC2_ETHERNET_ADDRESS = new EUI48(
			0x000022d8afb0b888L);
	private static final EUI48 MAC3_ETHERNET_ADDRESS = new EUI48(
			0x00004cfdc9a5e86aL);
	private static final EUI48 MAC4_ETHERNET_ADDRESS = new EUI48(
			0x000091038ffa38eeL);
	private static final EUI48 MAC5_ETHERNET_ADDRESS = new EUI48(
			0x00009857e4f202a3L);
	private static final EUI48 MAC6_ETHERNET_ADDRESS = new EUI48(
			0x0000a8c0600ccc69L);
	private static final EUI48 MAC7_ETHERNET_ADDRESS = new EUI48(
			0x0000a9a18860d8fcL);
	private static final EUI48 MAC8_ETHERNET_ADDRESS = new EUI48(
			0x0000c8b30f0b395aL);
	 ...
	 *************************************************************************/
	/**
	 * Test of EthernetAddress(byte[]) constructor, of class
	...
	public void testByteArrayEthernetAddressConstructor() {
		...
		try {
			/* EthernetAddress ethernet_address = */
			new EUI48(new byte[ETHERNET_ADDRESS_ARRAY_LENGTH - 1]);
			// if we reached here we failed because we didn't get an exception
			fail("Expected exception not caught");
	...
	/**
	 * Test of EthernetAddress(long) constructor, of class
	 * com.fasterxml.uuid.EthernetAddress.
	 */
	...
	/**
	 * Test of EthernetAddress(String) constructor, of class
	 * com.fasterxml.uuid.EthernetAddress.
	 */
	@Test
	...
	public void testAsByteArray() {
		...
		assertEthernetAddressArraysAreEqual(NULL_ETHERNET_ADDRESS_BYTE_ARRAY,
				0, ethernet_address.asByteArray(), 0);
		...
		assertEquals("Expected length of returned array wrong",
				ETHERNET_ADDRESS_ARRAY_LENGTH,
				ethernet_address.asByteArray().length);
		assertEthernetAddressArraysAreEqual(VALID_ETHERNET_ADDRESS_BYTE_ARRAY,
				0, ethernet_address.asByteArray(), 0);
		...
		assertEthernetAddressArraysAreNotEqual(ethernet_address.asByteArray(),
				0, ethernet_address_byte_array, 0);
		assertEthernetAddressArraysAreEqual(VALID_ETHERNET_ADDRESS_BYTE_ARRAY,
				0, ethernet_address.asByteArray(), 0);
	}
	...
	public void testClone() {
		...
		EUI48 x = new EUI48(VALID_ETHERNET_ADDRESS_STRING);
	...
	public void testCompareTo() {
		...
		assertEthernetAddressEqualOrderHelper(MAC0_ETHERNET_ADDRESS,
				new EUI48(MAC0_ETHERNET_ADDRESS.toLong()));
		...
		// 1 - mac8
		// 1 - mac9
		EUI48 ethernet_address_array[] = new EUI48[15];
		...
		assertEthernetAddressesMatchHelper(NULL_ETHERNET_ADDRESS,
				ethernet_address_array[0]);
		assertEthernetAddressesMatchHelper(MAC0_ETHERNET_ADDRESS,
				ethernet_address_array[1]);
		assertEthernetAddressesMatchHelper(MAC0_ETHERNET_ADDRESS,
				ethernet_address_array[2]);
		assertEthernetAddressesMatchHelper(MAC1_ETHERNET_ADDRESS,
				ethernet_address_array[3]);
		assertEthernetAddressesMatchHelper(MAC2_ETHERNET_ADDRESS,
				ethernet_address_array[4]);
		assertEthernetAddressesMatchHelper(MAC3_ETHERNET_ADDRESS,
				ethernet_address_array[5]);
		assertEthernetAddressesMatchHelper(MAC3_ETHERNET_ADDRESS,
				ethernet_address_array[6]);
		assertEthernetAddressesMatchHelper(MAC4_ETHERNET_ADDRESS,
				ethernet_address_array[7]);
		assertEthernetAddressesMatchHelper(MAC4_ETHERNET_ADDRESS,
				ethernet_address_array[8]);
		assertEthernetAddressesMatchHelper(MAC5_ETHERNET_ADDRESS,
				ethernet_address_array[9]);
		assertEthernetAddressesMatchHelper(MAC5_ETHERNET_ADDRESS,
				ethernet_address_array[10]);
		assertEthernetAddressesMatchHelper(MAC6_ETHERNET_ADDRESS,
				ethernet_address_array[11]);
		assertEthernetAddressesMatchHelper(MAC7_ETHERNET_ADDRESS,
				ethernet_address_array[12]);
		assertEthernetAddressesMatchHelper(MAC8_ETHERNET_ADDRESS,
				ethernet_address_array[13]);
		assertEthernetAddressesMatchHelper(MAC9_ETHERNET_ADDRESS,
				ethernet_address_array[14]);
	}
	...
	public void testToByteArray() {
		...
		assertEthernetAddressArraysAreEqual(NULL_ETHERNET_ADDRESS_BYTE_ARRAY,
				0, ethernet_address.toByteArray(), 0);
		...
		assertEthernetAddressArraysAreNotEqual(
				VALID_ETHERNET_ADDRESS_BYTE_ARRAY, 0,
				ethernet_address_byte_array, 0);
		assertEthernetAddressArraysAreNotEqual(ethernet_address.toByteArray(),
				0, ethernet_address_byte_array, 0);
		assertEthernetAddressArraysAreEqual(VALID_ETHERNET_ADDRESS_BYTE_ARRAY,
				0, ethernet_address.toByteArray(), 0);
	}
	...
	/**
	 * Test of toByteArray(byte[]) method, of class
	 * com.fasterxml.uuid.EthernetAddress.
	 */
	@Test
	public void testToByteArrayDest() {
		...
		for (int i = 0; i < EXTRA_DATA_LENGTH; i++) {
			assertEquals("Expected array fill value changed", (byte) 'x',
	...
	/**
	 * Test of toByteArray(byte[], int) method, of class
	 * com.fasterxml.uuid.EthernetAddress.
	 */
	@Test
	public void testToByteArrayDestOffset() {
		...
		assertEthernetAddressArraysAreEqual(NULL_ETHERNET_ADDRESS_BYTE_ARRAY,
				0, test_array, EXTRA_DATA_LENGTH / 2);
	...
	public void testToString() {
		...
		assertEquals("null EthernetAddress string and toString did not match",
				NULL_ETHERNET_ADDRESS_STRING.toLowerCase(), ethernet_address
		...
		assertFalse("mixed case EthernetAddress string and toString "
				...
				MIXED_CASE_VALID_ETHERNET_ADDRESS_STRING
						.equals(ethernet_address.toString()));
	...
	/**
	 * Test of valueOf(byte[]) method, of class
	 * com.fasterxml.uuid.EthernetAddress.
	 */
	@Test
	public void testValueOfByteArray() {
		...
		try {
			/* EthernetAddress ethernet_address = */
			EUI48
					.valueOf(new byte[ETHERNET_ADDRESS_ARRAY_LENGTH - 1]);
			// if we reached here we failed because we didn't get an exception
			fail("Expected exception not caught");
		} catch (NumberFormatException ex) {
			// this is the success case so do nothing
	...
	/**
	 * Test of valueOf(int[]) method, of class
	 * com.fasterxml.uuid.EthernetAddress.
	 */
	public void testValueOfIntArray() {
		...
		try {
			/* EthernetAddress ethernet_address = */
			EUI48.valueOf(new int[ETHERNET_ADDRESS_ARRAY_LENGTH - 1]);
			// if we reached here we failed because we didn't get an exception
			fail("Expected exception not caught");
		} catch (NumberFormatException ex) {
			// this is the success case so do nothing
	...
	/**
	 * Test of valueOf(long) method, of class
	 * com.fasterxml.uuid.EthernetAddress.
	 */
	...
	/**
	 * Test of valueOf(String) method, of class
	 * com.fasterxml.uuid.EthernetAddress.
	 */
	...
	private void badStringEthernetAddressConstructorHelper(
		...
		try {
			/* EthernetAddress ethernet_address = */
			new EUI48(ethernetAddressString);
			// if we reached here we failed because we didn't get an exception
			fail("Expected exception not caught");
		} catch (NumberFormatException ex) {
			// this is the success case so do nothing
	...
	private void goodStringEthernetAddressConstructorHelper(
		...
		try {
			ethernet_address = new EUI48(ethernetAddressString);
		} catch (Exception ex) {
			fail("Caught unexpected exception: " + ex);
		}

		assertEquals("EthernetAddresses were not equal",
				expectedEthernetAddressString.toLowerCase(), ethernet_address
						.toString().toLowerCase());
	}
	...
	private void badStringValueOfHelper(String ethernetAddressString) {
		try {
			/* EthernetAddress ethernet_address = */
			EUI48.valueOf(ethernetAddressString);
			// if we reached here we failed because we didn't get an exception
			fail("Expected exception not caught");
		} catch (NumberFormatException ex) {
			// this is the success case so do nothing
	...
	private void assertEthernetAddressesMatchHelper(EUI48 expected,
			EUI48 actual) {
	...
	private void assertEthernetAddressEqualOrderHelper(
			EUI48 ethernetAddress1, EUI48 ethernetAddress2) {
	...
	private void assertEthernetAddressArraysAreEqual(byte[] array1,
			int array1_start, byte[] array2, int array2_start) {
		...
		for (int i = 0; i < ETHERNET_ADDRESS_ARRAY_LENGTH; i++) {
			assertEquals("Array1 and Array2 did not match (index #" + i + ")",
					array1[i + array1_start], array2[i + array2_start]);
		}
	}
