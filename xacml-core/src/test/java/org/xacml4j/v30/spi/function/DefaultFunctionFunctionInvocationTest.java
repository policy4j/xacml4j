...
{
	private FunctionInvocation<ValueExpression> inv0;
	private FunctionInvocation<ValueExpression> inv1;
	private FunctionSpec spec;
	private IMocksControl c;
	private org.xacml4j.v30.spi.function.FunctionInvocation f0;
	private org.xacml4j.v30.spi.function.FunctionInvocation f1;
	...
	public void init(){
		...
		this.inv0 = c.createMock(FunctionInvocation.class);
		this.inv1 = c.createMock(FunctionInvocation.class);
	...
	public void testInvokeWithEvaluationContextFunctionIsNotVariadic() throws Exception
	{
		...
		expect(spec.getNumberOfParams()).andReturn(2);
		expect(spec.isVariadic()).andReturn(false).times(2);
		expect(inv1.invoke(context, XacmlTypes.INTEGER.of(1), XacmlTypes.INTEGER.of(2)))
