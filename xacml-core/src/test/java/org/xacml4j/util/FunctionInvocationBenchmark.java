...
public class FunctionInvocationBenchmark
{
	...
	private static long performBenchmark(int num, FunctionInvocation<?> invoke,
	...
	{
		FunctionInvocationFactory f = FunctionInvocationFactory.defaultFactory();
		FunctionInvocation<String> invoke = f.create(instance, TestObject.class.getMethod("test", String.class));
