...
public class Base64BinaryTypeTest 
{
	...
	public void testCreateValueFromBinaryArray()
	{
		byte[] v0 = {0, 1, 3, 5};
		byte[] v1 = {0, 1, 3, 5};
		Base64BinaryValueExp value1 = t.create(v0);
		Base64BinaryValueExp value2 = t.create(v1);
	...
	{
		byte[] data = {0, 1, 3, 5};
		Base64BinaryValueExp value1 = t.create("AAEDBQ==");
		Base64BinaryValueExp value2 = t.create(data);
		assertEquals(value1, value2);
	}
}
