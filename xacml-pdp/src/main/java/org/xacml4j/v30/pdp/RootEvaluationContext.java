...
public final class RootEvaluationContext implements DecisionRuleEvaluationContext {
	...
	private final List<IdReference> evaluatedPolicies;
	...
	public RootEvaluationContext(
		...
		this.evaluatedPolicies = new LinkedList<IdReference>();
	...
	{
		if(ref instanceof PolicyReference){
			return resolve((PolicyReference)ref);
		}
		if(ref instanceof PolicySetReference){
	...
	public Collection<IdReference> getEvaluatedPolicies() {
		return Collections.unmodifiableCollection(evaluatedPolicies);
	}
