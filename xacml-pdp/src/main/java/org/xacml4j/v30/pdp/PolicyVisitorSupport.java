...
public class PolicyVisitorSupport implements
        ...
        PolicySet.Visitor,
        Rule.Visitor,
        PolicyReference.Visitor,
        PolicySetReference.Visitor,
        ...
        VariableDefinition.Visitor
{
    ...
    @Override
    public void visitEnter(PolicyReference r) {

    }

    @Override
    public void visitLeave(PolicyReference r) {

    }

    @Override
    public void visitEnter(PolicySetReference r) {

    }

    @Override
    public void visitLeave(PolicySetReference r) {
