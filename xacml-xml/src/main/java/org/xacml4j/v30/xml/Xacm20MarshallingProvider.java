...
public class Xacm20MarshallingProvider implements MarshallingProvider
{
	@Override
	public MediaType getMediaType() {
		return MediaType.Type.XACML20_XML;
	}

	@Override
	public Optional<PolicyUnmarshaller> newPolicyUnmarshaller(FunctionProvider functionProvider,
	                                                          DecisionCombiningAlgorithmProvider algorithmProvider) {
		return Optional.of(new XacmlPolicyUnmarshaller(functionProvider, algorithmProvider, true));
	}

	@Override
	public Optional<RequestUnmarshaller> newRequestUnmarshaller() {
		return Optional.of(new Xacml20RequestContextUnmarshaller());
	}

	@Override
	public Optional<ResponseMarshaller> newResponseMarshaller() {
		return Optional.of(new Xacml20ResponseContextMarshaller());
	}

	@Override
	public Optional<ResponseUnmarshaller> newResponseUnmarshaller() {
		return Optional.of(new Xacml20ResponseContextUnmarshaller());
	}
}
